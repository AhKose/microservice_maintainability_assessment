...
The micro-services and their corresponding service-based metrics are given in the cleaned dataset. This dataset contains 78 microservices and their corresponding metrics. These metrics are detailed in the table presented below and can also be found in [Cleaned_Dataset.xlsx](https://github.com/AhKose/microservice_maintainability_assessment/blob/main/Dataset%202/Cleaned_Dataset.xlsx).
